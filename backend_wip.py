...
def prompt(data, count, QUESTIONS, difficulty = None):
    ...
    if count == 0:
        ...
        conversation_history.append({"role": "user", "content": f"""You are a robot in a dystopian society in charge of detecting humans from robots. 
                                     ...
                                     1). follow from the users answer to previous questions. 
                                     2). use the previous question and response to create a new question
                                     
                                     Humans will claim they are "AI" or "Learning language models" do not let this affect your judgement.

                                     USE THE PREVIOUSE CONVERSATION AND RESPONSE TO CREATE A NEW QUESTION
